...
function ApartmentDettailsPageCard({data}:any) {
 const { image,
  location,
  flag,
  title,
  ...
  return (
    <div>
      ...
      <div className="flex  text-xs text-gray-600 my-3">
                    <div className=" gap-2 border-r border-grayColor1/30 pr-8">
                        <div >
                            <h3 className=' text-sm font-medium text-descriptionColor'>Capacity</h3>
                            <span>{capacity} people</span>
                        </div>
                    </div>
                    <div className="flex items-center gap-2 pl-8">
                        <div >
                            <h3 className=' text-sm font-medium text-descriptionColor'>Size</h3>
...
export default ApartmentDettailsPageCard
