...
export default function AccommodationCard({ tour }: { tour: Package }) {
  const { id, name, type, reviews, roomFiles, amenities, bedrooms, total_bedrooms, bathrooms, cancellation_policy, breakfast_available, price, address, rating_summary } = tour
