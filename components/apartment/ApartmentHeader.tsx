  ...
  return (
    <div className="lg:flex justify-between items-center pb-8">
      ...
      <div className="flex flex-col">
        <h2 className=" text-2xl lg:text-5xl font-semibold mb-2">{singleApartment?.name || "Property Name"}</h2>
        <div className=" flex ">
          <div className="pr-5 lg:pr-16 border-r border-y-grayColor1/20">
            ...
            <div className="flex gap-2 items-center text-sm text-yellow-500 mb-2 ">
              <Rating rating={singleApartment?.rating_summary?.averageRating} />
              <span className="text-gray-500">({singleApartment?.rating_summary?.totalReviews} reviews)</span>
            </div>
          </div>
          <div className="text-base text-headerColor pl-5 lg:pl-16">
            <h4 className=" text-base text-grayColor1 mb-1">Location</h4>
            <p className="text-base text-headerColor">{singleApartment?.address}</p>
          </div>
        </div>
      </div>
      {/* Right side: Price */}
