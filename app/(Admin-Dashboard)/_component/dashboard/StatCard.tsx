...
export default function StatCard  ({ title, count, iconPath }: StatCardProps){
    return(
  <div className="flex-1 xl:p-6 p-2 bg-neutral-50 rounded-lg flex items-center gap-1.5 md:gap-2.5">
    ...
    <div className="flex flex-col md:gap-2">
      <div className="text-[#070707] text-sm sm:text-base font-medium">{title}</div>
      <div className="text-[#777980] text-xs">{count}</div>
    </div>
  </div>
)}
