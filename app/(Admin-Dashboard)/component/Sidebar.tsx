...
const navItems: NavItem[] = [
  { icon: '/admin/user.svg', label: 'User dashboard', href: '/dashboard', isActive: true },
  { icon: '/admin/time-management.svg', label: 'Manage bookings', href: '/dashboard/bookings' },
  { icon: '/admin/check-list.svg', label: 'Listing management', href: '/dashboard/listings' },
  { icon: '/admin/mentoring.svg', label: 'Payment monitor', href: '/dashboard/payments' },
  { icon: '/admin/view.svg', label: 'Manage review', href: '/dashboard/reviews' },
  { icon: '/admin/notification-02.svg', label: 'Manage notifications', href: '/dashboard/notifications' },
  { icon: '/admin/settings-01.svg', label: 'Platform setting', href: '/dashboard/settings' },
  { icon: '/admin/service.svg', label: 'Terms of service', href: '/dashboard/terms' },
];
