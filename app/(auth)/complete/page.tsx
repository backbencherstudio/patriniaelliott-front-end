  ...
  return (
    <section className="max-w-[1346px] mx-auto min-h-screen flex items-center">
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-8 items-center  h-full">
        ...
        <Image src="/auth/complete.jpg" alt="Complete" width={650} height={750} className=" w-full " />
        </div>
        <div className=" w-full flex flex-col justify-center items-center space-y-8">
          <Image src="/auth/completeicon.png" alt="Complete Icon" width={182} height={182} className="" />
