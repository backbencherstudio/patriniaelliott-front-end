    ...
    <div className="w-[960px] inline-flex flex-col justify-start items-center my-10">
      ...
      <div className="self-stretch px-4 pb-4 bg-white rounded-bl-xl rounded-br-xl inline-flex justify-start items-center">
        ...
        <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
          ...
          {tourData.map((tour) => (
            <div key={tour.id} className="self-stretch p-4 border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
              <div className={`pl-1.5 pr-2 py-1.5 ${tour.status === "Completed" ? "bg-[#38c976]/10 outline-[#abefc6]" : "bg-[#fe5050]/10 outline-[#fe5050]"} rounded-2xl outline outline-1 outline-offset-[-1px] flex justify-start items-center gap-1`}>
