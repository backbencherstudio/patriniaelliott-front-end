...
export default function Refund() {
  return (
    <>
      <div className="w-[960px] px-6 py-[23px] bg-white rounded-xl inline-flex flex-col justify-start items-start gap-6 my-10">
        <div className="w-[339px] flex flex-col justify-start items-start gap-[15px]">
          <div className="self-stretch justify-center text-[#070707] text-2xl font-medium font-['Inter'] leading-normal">Refund user</div>
          <div className="self-stretch justify-center text-[#777980] text-base font-normal font-['Inter'] leading-none tracking-tight">Check up on your latest refund history.</div>
        </div>
        <div className="self-stretch bg-white rounded-xl inline-flex justify-start items-center">
          <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
            <div className="self-stretch h-14 p-4 bg-neutral-50 rounded-tl-xl inline-flex justify-start items-center gap-2.5 overflow-hidden">
              <div className="flex-1 justify-center text-[#4a4c56] text-sm font-normal font-['Inter'] leading-[14px]">Hotel/Tour name</div>
            </div>
            {refundData.map((item) => (
              <div key={item.id} className="self-stretch p-4 border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
                ...
                <div className="justify-center text-[#070707] text-xs font-normal font-['Inter'] leading-3">{item.hotelName}</div>
              </div>
            ))}
          </div>
          <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
            <div className="self-stretch h-14 p-4 bg-neutral-50 inline-flex justify-start items-center gap-2.5 overflow-hidden">
              <div className="flex-1 justify-center text-[#4a4c56] text-sm font-normal font-['Inter'] leading-[14px]">Price</div>
            </div>
            {refundData.map((item) => (
              <div key={item.id} className="self-stretch px-4 py-[22px] border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
                <div className="justify-center text-[#777980] text-xs font-normal font-['Inter'] leading-3">{item.price}</div>
              </div>
            ))}
          </div>
          <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
            <div className="self-stretch h-14 p-4 bg-neutral-50 inline-flex justify-start items-center gap-2.5 overflow-hidden">
              <div className="flex-1 justify-center text-[#4a4c56] text-sm font-normal font-['Inter'] leading-[14px]">Time & Date</div>
            </div>
            {refundData.map((item) => (
              <div key={item.id} className="self-stretch px-4 py-[22px] border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
          ...
          <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
            ...
            {refundData.map((item) => {
              ...
              return (
                <div key={item.id} className="self-stretch p-4 border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
                  <div className={`pl-1.5 pr-2 py-1.5 ${styles.bg} rounded-2xl outline outline-1 outline-offset-[-1px] ${styles.border} flex justify-start items-center gap-1`}>
                    <img src={styles.icon} alt={item.status} className="w-3 h-3" />
                    <div className={`text-center justify-start ${styles.text} text-xs font-normal font-['Inter'] leading-3`}>
          ...
          <div className="flex-1 inline-flex flex-col justify-start items-start gap-2">
            <div className="self-stretch h-14 p-4 bg-neutral-50 rounded-tr-xl inline-flex justify-start items-center gap-2.5 overflow-hidden">
              <div className="justify-center text-[#4a4c56] text-sm font-normal font-['Inter'] leading-[14px]">Refund Amount</div>
            </div>
            {refundData.map((item) => (
              <div key={item.id} className="self-stretch px-4 py-[22px] border-b border-[#eaecf0] inline-flex justify-start items-center gap-3 overflow-hidden">
                <div className="justify-center text-[#777980] text-xs font-normal font-['Inter'] leading-3">{item.refundAmount}</div>
              </div>
            ))}
          </div>
        </div>
