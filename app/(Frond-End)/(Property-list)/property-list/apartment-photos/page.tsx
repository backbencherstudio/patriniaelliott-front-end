                            ...
                            <div className="space-y-6 bg-white p-6 rounded-lg">
                                <div className="space-y-4">
                                    ...
                                    <div className="">
                                        ...
                                        <span className="text-[#777980] text-sm">The more you upload,
                                            the more likely you are to get bookings. You can add more later.</span>
                                    </div>
                                </div>
                                <div className="space-y-6">
                                    <div
                                        {...getRootProps()}
                                        className={`border-2 border-dashed rounded-lg p-[48px] text-center cursor-pointer transition-colors
          ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-[#4A4C56] hover:border-gray-400'}`}
                                    >
                                        <input {...getInputProps()} required />

                                        <div className="flex flex-col items-center space-y-6">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="73" height="72" viewBox="0 0 73 72" fill="none">
                                                <g clip-path="url(#clip0_5471_15454)">
                                            ...
                                            <div className="space-y-3 flex flex-col items-center">
                                                ...
                                                >
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                        ...
                                                        <path d="M12.9154 11.6667C12.9154 13.2775 11.6095 14.5833 9.9987 14.5833C8.38786 14.5833 7.08203 13.2775 7.08203 11.6667C7.08203 10.0558 8.38786 8.75 9.9987 8.75C11.6095 8.75 12.9154 10.0558 12.9154 11.6667Z" stroke="#0068EF" stroke-width="1.5" />
                                                        <path d="M10 5H10.009" stroke="#0068EF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                            ...
                            {isSuggestionOpen && <div className="bg-[#FFFBEE] p-4 rounded-[12px] flex gap-[6px] w-full">
                                ...
                                <div className="space-y-2 w-full">
                                    ...
                                    <div className="text-[#4A4C56] text-sm space-y-2">
                                        <p className="">No problem! You can use a
                                            smartphone or a digital
                                            camera. Here are some tips for taking great photos of your
                                            property</p>
                                        <div>
                                            <a href="#" className="text-[#0068EF]">Here are some tips for taking great
                                                photos of your property</a>
                                        </div>
                                        <p>If you don't know who took a
                                            photo, it's best not to use it. Only
                                            use photos others have taken if you
                                            have permission.</p>
                                    </div>
                                </div>
