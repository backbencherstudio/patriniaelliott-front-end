...
import tourCover from '@/public/toure/t6.jpg'
            ...
            <div className="space-y-6">
                <div className="space-y-[32px] bg-white p-6 rounded-[24px]">
                    ...
                    <div className="flex flex-col sm:flex-row gap-[32px]">
                        <div>
                            <Image src={listProperty?.type === "Tour" ? tourCover : coverImage} alt="Overview" className="w-full min-w-[300px] max-w-[500px] h-full max-h-[250px] rounded-[16px]" />
                        </div>
                        <div className="pl-[10px] sm:pl-[15px] pt-3">
                            {listProperty?.type === 'Tour' ? <ul className="border-l border-[#D6AE29] space-y-5 text-[#4A4C56] text-[18px]">
                                {
                ...
                <div className="flex justify-between w-full space-x-3 px-4">
                    ...
                    {listProperty?.type === "Tour" ? <button className="text-[#fff] px-6 sm:px-[32px] py-2 sm:py-3 border border-[#fff] bg-[#0068EF] rounded-[8px] cursor-pointer" onClick={() => router.push("/property-list/setup/tour-host")}>Continue</button>
                        :
