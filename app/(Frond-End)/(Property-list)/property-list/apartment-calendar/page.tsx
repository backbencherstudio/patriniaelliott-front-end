        ...
        <div className="flex justify-center items-center w-full bg-[#F6F7F7]">
            <div className="py-15 px-4 max-w-[1320px] w-full space-y-[48px]">
                ...
                <div className="flex justify-between w-full space-x-3 px-4">
                    ...
                    <button type="button" className="text-[#fff] px-6 sm:px-[32px] py-2 sm:py-3 border border-[#fff] bg-[#0068EF] rounded-[8px] cursor-pointer" onClick={() => console.log("Form is submitted...")}>Continue</button>
                </div>
            </div>
        </div>
    )
