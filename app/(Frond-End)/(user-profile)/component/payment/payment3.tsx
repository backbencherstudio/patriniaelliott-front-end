...
export default function Payment3({ onAddCard }: Payment3Props) {
  return (
    <div className="w-[960px] p-6 bg-white rounded-xl flex flex-col gap-6 my-10">
      ...
      <div className="p-2.5 rounded-lg border border-[#e9e9ea] flex justify-between items-center">
        ...
        <button className="p-3 rounded-lg shadow-sm cursor-pointer hover:bg-gray-50 transition-colors">
      ...
      <div className="flex justify-end items-center gap-6">
        ...
        <button 
          onClick={onAddCard}
          className="px-8 py-3 rounded-lg border border-[#0068ef] cursor-pointer hover:bg-[#0068ef]/5 transition-colors"
        >
